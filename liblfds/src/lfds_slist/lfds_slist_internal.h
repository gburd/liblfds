...
/***** defines *****/
#define LFDS_SLIST_USER_DATA  0
#define LFDS_SLIST_FLAGS      1

#define LFDS_SLIST_NO_FLAGS      0x0
#define LFDS_SLIST_FLAG_DELETED  0x1

/***** structures *****/
#pragma pack( push, LFDS_ALIGN_SINGLE_POINTER )
...
void lfds_slist_internal_link_element_to_head( struct lfds_slist_state *lfds_slist_state, struct lfds_slist_element *volatile se );
